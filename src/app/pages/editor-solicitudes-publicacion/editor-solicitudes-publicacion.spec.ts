...
describe('EditorSolicitudesPublicacion', () => {
  ...
  it('muestra los datos, la miniatura segura y el enlace al PDF sin estados editoriales', () => {
    ...
    const pdf = fixture.nativeElement.querySelector('.request-pdf') as HTMLAnchorElement;
    ...
    expect(fixture.nativeElement.querySelector('.request-card button')).toBeNull();
    expect(image.alt).toBe('Portada de Abierto del Valle');
    expect(image.src).toContain('/api/editor/solicitudes-publicacion/9/archivos/imagen');
