...
export class CompartirEvento {
  ...
  protected readonly urlWhatsApp = computed(() => this.compartirService.urlWhatsApp(this.slug(), this.titulo()));
  protected readonly urlFacebook = computed(() => this.compartirService.urlFacebook(this.slug()));
  protected readonly urlTwitter = computed(() => this.compartirService.urlTwitter(this.slug(), this.titulo()));
